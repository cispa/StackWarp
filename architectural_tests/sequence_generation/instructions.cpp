...
/*
 * The instructions in this file were extracted from 'x86emitter.h' in asmjit.
 */

#define NO_CONTROL_FLOW 1


typedef asmjit::x86::Gp ttGp;
typedef asmjit::x86::Gp ttGp_ZDI;
typedef asmjit::x86::Gp ttGp_ZSI;
typedef asmjit::x86::Gp ttGp_RAX;
typedef asmjit::x86::Gp ttGp_RBX;
typedef asmjit::x86::Gp ttGp_RCX;
typedef asmjit::x86::Gp ttGp_RDX;
typedef asmjit::x86::Gp ttGp_ZAX;
typedef asmjit::x86::Gp ttGp_ZBX;
typedef asmjit::x86::Gp ttGp_ZCX;
typedef asmjit::x86::Gp ttGp_ZDX;
typedef asmjit::x86::Gp ttGp_EAX;
typedef asmjit::x86::Gp ttGp_EBX;
typedef asmjit::x86::Gp ttGp_ECX;
typedef asmjit::x86::Gp ttGp_EDX;
typedef asmjit::x86::Gp ttGp_AH;
typedef asmjit::x86::Gp ttGp_AL;
typedef asmjit::x86::Gp ttGp_CL;
typedef asmjit::x86::Gp ttGp_CX;
typedef asmjit::x86::Gp ttGp_AX;
typedef asmjit::x86::Gp ttGp_DX;
typedef asmjit::Imm ttImm;
typedef asmjit::x86::Xmm ttXmm;
typedef asmjit::x86::Vec ttVec;
typedef asmjit::Label ttLabel;
typedef asmjit::x86::Mem ttMem;
typedef asmjit::x86::KReg ttKReg;

#define Gp GPQ
#define Imm IMM

template<typename T>
static void update_param(T &, const asmjit::Label &) {}

static void updade_param(asmjit::Label &t, const asmjit::Label &l) { t = l; }


#define REGISTER_INSTRUCTION(cls)                                                   \
    namespace {                                                                     \
        static Instruction* create##cls() { return new cls(); }                     \
        struct cls##Registrar {                                                     \
            cls##Registrar() { Instruction::registerClass(create##cls); }           \
        } cls##registrar;                                                           \
    }
#define ASMJIT_INST_0x(mnemonic, family)                                            \
    class Instruction_##mnemonic : public Instruction {                             \
        public:                                                                     \
            virtual void emit(asmjit::x86::Assembler& a, const asmjit::Label &l) const { \
                a.mnemonic();                                                       \
            };                                                                      \
            Instruction_##mnemonic() {}                                             \
    };                                                                              \
    REGISTER_INSTRUCTION(Instruction_##mnemonic)


#define ASMJIT_INST_1x(mnemonic, family, optype1)                                   \
    class Instruction_##mnemonic##optype1 : public Instruction {                    \
            tt##optype1 parameter1;                                                     \
            void init_random() {                      \
                parameter1 = get_random_##optype1();                                \
            };                                                                      \
        public:  \
            virtual void emit(asmjit::x86::Assembler& a, const asmjit::Label &l) const { \
                update_param(parameter1, l);                                         \
                a.mnemonic(parameter1);                                             \
            }                                                                       \
            Instruction_##mnemonic##optype1 () { \
                init_random();                          \
            };                  \
    };                                                                              \
    REGISTER_INSTRUCTION(Instruction_##mnemonic##optype1)

#define ASMJIT_INST_2x(mnemonic, family, optype1, optype2)                          \
    class Instruction_##mnemonic##optype1##optype2 : public Instruction {           \
        tt##optype1 parameter1;                                                     \
        tt##optype2 parameter2;                                                     \
            void init_random() {                                            \
                parameter1 = get_random_##optype1();                                \
                parameter2 = get_random_##optype2();                                \
            };                                                                      \
        public:\
            virtual void emit(asmjit::x86::Assembler& a, const asmjit::Label &l) const {                    \
                update_param(parameter1, l); update_param(parameter2, l); \
                a.mnemonic(parameter1, parameter2);                                 \
            }   \
            Instruction_##mnemonic##optype1##optype2 () {                           \
                init_random();  \
            };   \
    };                                                                              \
    REGISTER_INSTRUCTION(Instruction_##mnemonic##optype1##optype2)

#define ASMJIT_INST_3x(mnemonic, family, optype1, optype2, optype3)                 \
    class Instruction_##mnemonic##optype1##optype2##optype3 : public Instruction {  \
        tt##optype1 parameter1;                                                     \
        tt##optype2 parameter2;                                                     \
        tt##optype3 parameter3;                                                     \
            void init_random() {                      \
                parameter1 = get_random_##optype1();                                \
                parameter2 = get_random_##optype2();                                \
                parameter3 = get_random_##optype3();                                \
            };                                                                      \
        public:\
            virtual void emit(asmjit::x86::Assembler& a, const asmjit::Label &l) const {  \
                update_param(parameter1, l); update_param(parameter2, l); update_param(parameter3, l); \
                a.mnemonic(parameter1, parameter2, parameter3);                     \
            }                                                                       \
            Instruction_##mnemonic##optype1##optype2##optype3 () {  \
                init_random();                              \
            }; \
    };                                                                              \
    REGISTER_INSTRUCTION(Instruction_##mnemonic##optype1##optype2##optype3)
#define ASMJIT_INST_4x(mnemonic, family, optype1, optype2, optype3, optype4)                 \
    class Instruction_##mnemonic##optype1##optype2##optype3##optype4 : public Instruction {  \
        tt##optype1 parameter1;                                                     \
        tt##optype2 parameter2;                                                     \
        tt##optype3 parameter3;                                                     \
        tt##optype4 parameter4;                                                     \
            void init_random() {                      \
                parameter1 = get_random_##optype1();                                \
                parameter2 = get_random_##optype2();                                \
                parameter3 = get_random_##optype3();                                \
                parameter4 = get_random_##optype4();                                \
            };                                                                               \
        public: \
            virtual void emit(asmjit::x86::Assembler& a, const asmjit::Label &l) const {                    \
            update_param(parameter1, l); update_param(parameter2, l); update_param(parameter3, l); update_param(parameter4, l); \
                a.mnemonic(parameter1, parameter2, parameter3, parameter4);         \
            }                                                                       \
            Instruction_##mnemonic##optype1##optype2##optype3##optype4 () {         \
                init_random();                                                     \
            };                                                                      \
    };                                                                              \
    REGISTER_INSTRUCTION(Instruction_##mnemonic##optype1##optype2##optype3##optype4)

#define ASMJIT_INST_5x(mnemonic, family, optype1, optype2, optype3, optype4, optype5)                 \
    class Instruction_##mnemonic##optype1##optype2##optype3##optype4##optype5 : public Instruction {  \
        tt##optype1 parameter1;                                                     \
        tt##optype2 parameter2;                                                     \
        tt##optype3 parameter3;                                                     \
        tt##optype4 parameter4;                                                     \
        tt##optype5 parameter5;                                                     \
            void init_random() {                                                    \
                parameter1 = get_random_##optype1();                                \
                parameter2 = get_random_##optype2();                                \
                parameter3 = get_random_##optype3();                                \
                parameter4 = get_random_##optype4();                                \
                parameter5 = get_random_##optype5();                                \
            };                                                                                        \
            public:\
            virtual void emit(asmjit::x86::Assembler& a, const asmjit::Label& l) const {                    \
            update_param(parameter1, l); update_param(parameter2, l); update_param(parameter3, l); update_param(parameter4, l); update_param(parameter5, l);\
                a.mnemonic(parameter1, parameter2, parameter3, parameter4,          \
                    parameter5);                                                    \
            }                                                                       \
            Instruction_##mnemonic##optype1##optype2##optype3##optype4##optype5 () {  \
                init_random();                                                     \
            };                                                                      \
    };                                                                              \
    REGISTER_INSTRUCTION(Instruction_##mnemonic##optype1##optype2##optype3##optype4##optype5)

/*
 * Only contains instructions that use registers and immediates exclusively
 * See 'x86emitter.h' in asmjit for the full list
*/
//! \}
  ...
  */
  ...
  ASMJIT_INST_2x(blendvpd, Blendvpd, Xmm, Xmm)                   // SSE4_1 [EXPLICIT]
  ASMJIT_INST_2x(blendvpd, Blendvpd, Xmm, Mem)                   // SSE4_1 [EXPLICIT]
  ASMJIT_INST_2x(blendvps, Blendvps, Xmm, Xmm)                   // SSE4_1 [EXPLICIT]
  ASMJIT_INST_2x(blendvps, Blendvps, Xmm, Mem)                   // SSE4_1 [EXPLICIT]
  ...
  //ASMJIT_INST_2x(maskmovq, Maskmovq, Mm, Mm)                   // SSE  [EXPLICIT]
  ASMJIT_INST_2x(maskmovdqu, Maskmovdqu, Xmm, Xmm)             // SSE2 [EXPLICIT]
  ...
  ASMJIT_INST_3x(pcmpestri, Pcmpestri, Xmm, Xmm, Imm) // SSE4_2 [EXPLICIT]
  ASMJIT_INST_3x(pcmpestri, Pcmpestri, Xmm, Mem, Imm) // SSE4_2 [EXPLICIT]
  ASMJIT_INST_3x(pcmpestrm, Pcmpestrm, Xmm, Xmm, Imm)   // SSE4_2 [EXPLICIT]
  ASMJIT_INST_3x(pcmpestrm, Pcmpestrm, Xmm, Mem, Imm)   // SSE4_2 [EXPLICIT]
  ...
  ASMJIT_INST_3x(pcmpistri, Pcmpistri, Xmm, Xmm, Imm)          // SSE4_2 [EXPLICIT]
  ASMJIT_INST_3x(pcmpistri, Pcmpistri, Xmm, Mem, Imm)          // SSE4_2 [EXPLICIT]
  ASMJIT_INST_3x(pcmpistrm, Pcmpistrm, Xmm, Xmm, Imm)            // SSE4_2 [EXPLICIT]
  ASMJIT_INST_3x(pcmpistrm, Pcmpistrm, Xmm, Mem, Imm)            // SSE4_2 [EXPLICIT]
...
*/
 ...
 // ASMJIT_INST_3x(sha256rnds2, Sha256rnds2, Xmm, Mem, XMM0)             // SHA [EXPLICIT]
  ...
  //ASMJIT_INST_2x(vmaskmovdqu, Vmaskmovdqu, Vec, Vec)           // AVX  [EXPLICIT]
  ...
  //ASMJIT_INST_3x(vpcmpestri, Vpcmpestri, Vec, Vec, Imm) // AVX  [EXPLICIT]
  //ASMJIT_INST_3x(vpcmpestri, Vpcmpestri, Vec, Mem, Imm) // AVX  [EXPLICIT]
  //ASMJIT_INST_3x(vpcmpestrm, Vpcmpestrm, Vec, Vec, Imm)   // AVX  [EXPLICIT]
  //ASMJIT_INST_3x(vpcmpestrm, Vpcmpestrm, Vec, Mem, Imm)   // AVX  [EXPLICIT]
  ...
  //ASMJIT_INST_3x(vpcmpistri, Vpcmpistri, Vec, Vec, Imm)        // AVX  [EXPLICIT]
  //ASMJIT_INST_3x(vpcmpistri, Vpcmpistri, Vec, Mem, Imm)        // AVX  [EXPLICIT]
